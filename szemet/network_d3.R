...
# simpleNetwork
src <- c("Mészáros Lőrinc", "Mészáros Lőrinc", "Mészáros Lőrinc", "Mészáros Gasztro Kft.", "Mészáros Gasztro Kft.", "Talentis Group Zrt.")
...
forceNetwork(Links = MisLinks, Nodes = MisNodes, Source = "source",
             ...
             Group = "group", opacity = 1, zoom = T, bounded = T, arrows = T)
